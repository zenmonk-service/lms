    ...
    return (
      <div className="flex h-10 items-center">
        ...
        >
          <SelectTrigger
            ref={ref}
            className="w-16 focus:bg-accent focus:text-accent-foreground"
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          "w-12 text-center text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
          className
        )}
  ...
  (
    {
      ...
      onChange,
      hourCycle = 24,
      // yearRange kept for API compatibility (not used directly)
      yearRange = 50,
      disabled = false,
      displayFormat,
      granularity = "second",
    ...
    // Preserve time when changing only the day
    ...
    // time changes handled by original TimePicker component below
    ...
    // Build display format compatible with previous component
    ...
    // using original input-driven TimePicker below
