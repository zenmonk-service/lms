    ...
    <div className="bg-background">
      ...
      <Tabs defaultValue="details" className="w-full">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1.5 font-medium">{selectedUser.email}</p>
              {isEditing && (
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <Badge variant="secondary" className="rounded-lg border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-medium hover:bg-primary/15 transition-colors">
          ...
          <div className="flex items-center gap-3">
            {isEditing ? (
              <>
                <Button variant="outline" className="rounded-lg px-6 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all" onClick={handleCancelEdit}>
                  Cancel
                </Button>
                <Button className="rounded-lg shadow-lg hover:shadow-xl px-6 bg-linear-to-r from-primary to-primary/90 hover:from-primary hover:to-primary/80 transition-all" onClick={handleSubmit(onSubmit)} disabled={isSaving}>
                  {isSaving ? <Loader2 className="animate-spin mr-2" /> : <Save className="mr-2" />}
                  Save changes
                </Button>
              </>
            ) : (
              <Button className="rounded-lg shadow-lg hover:shadow-xl px-6 bg-linear-to-r from-primary to-primary/90 hover:from-primary hover:to-primary/80 transition-all" onClick={() => setIsEditing(true)}>
          ...
          <CardContent>
            <Tabs defaultValue="basic" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6 bg-slate-100/60 dark:bg-slate-900/40 rounded-lg p-1 border border-border/30">
                <TabsTrigger value="basic" className="rounded-md font-medium transition-all data-[state=active]:bg-white data-[state=active]:shadow-sm">Basic & Employment</TabsTrigger>
                <TabsTrigger value="contact" className="rounded-md font-medium transition-all data-[state=active]:bg-white data-[state=active]:shadow-sm">Contact</TabsTrigger>
                <TabsTrigger value="documents" className="rounded-md font-medium transition-all data-[state=active]:bg-white data-[state=active]:shadow-sm">Documents</TabsTrigger>
              </TabsList>
                ...
                <div className="rounded-2xl border border-border/40 bg-linear-to-br from-slate-50/80 to-slate-50/40 dark:from-slate-900/30 dark:to-slate-900/20 p-6 shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="border-t border-border/40 pt-7 mt-7">
                    <div className="mb-5 flex items-center gap-3">
                      ...
                      <p className="text-base font-bold text-foreground">Employment details</p>
                    </div>
                    <div className="grid gap-4 md:grid-cols-2">
                      <Field>
              ...
              <TabsContent value="contact" className="space-y-4">
                <div className="rounded-2xl border border-border/40 bg-linear-to-br from-slate-50/80 to-slate-50/40 dark:from-slate-900/30 dark:to-slate-900/20 p-6 shadow-sm hover:shadow-md transition-all">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <p className="text-base font-bold text-foreground">Contact information</p>
                  </div>
                  <div className="grid gap-4 md:grid-cols-2">
                    <Field>
              ...
              <TabsContent value="documents" className="space-y-4">
                <div className="rounded-2xl border border-border/40 bg-linear-to-br from-slate-50/80 to-slate-50/40 dark:from-slate-900/30 dark:to-slate-900/20 p-6 space-y-5 shadow-sm hover:shadow-md transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-base font-bold text-foreground">Employee documents</p>
                  </div>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <Dashboard organization_uuid={organizationUuid} email={currentUser?.email || ""} targetUserId={selectedUser.user_id} targetUserName={selectedUser.name} targetUserEmail={selectedUser.email} />
        </TabsContent>
      </Tabs>
      </div>
      ...
      <AlertDialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this document? This action cannot be undone. The document will be permanently removed when you save changes.
            </AlertDialogDescription>
          </AlertDialogHeader>
