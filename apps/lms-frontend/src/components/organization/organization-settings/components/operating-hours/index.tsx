            ...
            <div className="flex-1 flex justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Allow employees to flexible working hours within the defined
                  start and end time.
                </p>
              </div>
              <div>
                ...
                render={({ field }) => (
                  <Switch
                    ...
                    onCheckedChange={(val) => {
                      ...
                      field.onChange(!val ? null : startOfDay);
                    }}
                  />
                )}
              />
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field className="gap-1">
                    ...
                    <InputGroup className="rounded-none border-none shadow-none mt-4">
                      <TimePicker
                        date={field.value}
                        hourCycle={24}
                        granularity="minute"
